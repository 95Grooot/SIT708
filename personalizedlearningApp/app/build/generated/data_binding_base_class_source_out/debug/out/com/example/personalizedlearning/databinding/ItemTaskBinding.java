...
public final class ItemTaskBinding implements ViewBinding {
  ...
  private ItemTaskBinding(@NonNull LinearLayout rootView, @NonNull TextView tvDifficulty,
  ...
  public static ItemTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTaskBinding((LinearLayout) rootView, tvDifficulty, tvTaskDescription,
          tvTaskTitle);
    }
